...
// End Cross Module References
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOpenAICallCompletions_OpenAICallCompletions_Statics::NewProp_engine_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOpenAICallCompletions_OpenAICallCompletions_Statics::NewProp_engine = { "engine", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallCompletions_eventOpenAICallCompletions_Parms, engine), Z_Construct_UEnum_OpenAIAPI_EOACompletionsEngineType, METADATA_PARAMS(nullptr, 0) }; // 30256229
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOpenAICallCompletions_OpenAICallCompletions_Statics::NewProp_prompt = { "prompt", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallCompletions_eventOpenAICallCompletions_Parms, prompt), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOpenAICallCompletions_OpenAICallCompletions_Statics::NewProp_settings = { "settings", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallCompletions_eventOpenAICallCompletions_Parms, settings), Z_Construct_UScriptStruct_FCompletionSettings, METADATA_PARAMS(nullptr, 0) }; // 3779655512
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOpenAICallCompletions_OpenAICallCompletions_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(OpenAICallCompletions_eventOpenAICallCompletions_Parms, ReturnValue), Z_Construct_UClass_UOpenAICallCompletions_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenAICallCompletions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOpenAICallCompletions_OpenAICallCompletions, "OpenAICallCompletions" }, // 4078689909
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOpenAICallCompletions_Statics::NewProp_Finished = { "Finished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOpenAICallCompletions, Finished), Z_Construct_UDelegateFunction_OpenAIAPI_OnGptResponseRecievedPin__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UOpenAICallCompletions_Statics::NewProp_Finished_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOpenAICallCompletions_Statics::NewProp_Finished_MetaData)) }; // 3255876154
	...
	struct Z_CompiledInDeferFile_FID_Users_KMYTHEN_Documents_Builds_OpenAIBuilds_AltVersions_OpenAIAPI_HostProject_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_KMYTHEN_Documents_Builds_OpenAIBuilds_AltVersions_OpenAIAPI_HostProject_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenAICallCompletions, UOpenAICallCompletions::StaticClass, TEXT("UOpenAICallCompletions"), &Z_Registration_Info_UClass_UOpenAICallCompletions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenAICallCompletions), 1830707653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_KMYTHEN_Documents_Builds_OpenAIBuilds_AltVersions_OpenAIAPI_HostProject_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_310650031(TEXT("/Script/OpenAIAPI"),
		Z_CompiledInDeferFile_FID_Users_KMYTHEN_Documents_Builds_OpenAIBuilds_AltVersions_OpenAIAPI_HostProject_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_KMYTHEN_Documents_Builds_OpenAIBuilds_AltVersions_OpenAIAPI_HostProject_Plugins_OpenAIAPI_Source_OpenAIAPI_Public_OpenAICallCompletions_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
